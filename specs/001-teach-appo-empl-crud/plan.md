...
**Branch**: `001-teach-appo-empl-crud` | **Date**: 2026-02-11 | **Spec**: [specs/001-teach-appo-empl-crud/spec.md](specs/001-teach-appo-empl-crud/spec.md)
**Input**: Feature specification from `/specs/001-teach-appo-empl-crud/spec.md`
...
**Primary Dependencies**: ASP.NET Core Razor Pages, Entity Framework Core 8 (SQLite + SQL Server providers)  
**Storage**: SQLite (current app configuration), schema managed by EF Core migrations  
...
**Structure Decision**: Single Razor Pages web project using existing `Data/`, `Models/`, and `Pages/` folders.
...
Output: [specs/001-teach-appo-empl-crud/research.md](specs/001-teach-appo-empl-crud/research.md)
...
- Data model: [specs/001-teach-appo-empl-crud/data-model.md](specs/001-teach-appo-empl-crud/data-model.md)
- Contracts: [specs/001-teach-appo-empl-crud/contracts/teach-appo-empl-base.openapi.yaml](specs/001-teach-appo-empl-crud/contracts/teach-appo-empl-base.openapi.yaml)
- Quickstart: [specs/001-teach-appo-empl-crud/quickstart.md](specs/001-teach-appo-empl-crud/quickstart.md)
