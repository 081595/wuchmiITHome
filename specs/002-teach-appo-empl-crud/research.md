...
- **Decision**: Treat timestamps as server-managed and read-only in UI; set values on add/modify in the data layer and do not bind from forms. Use SQLite defaults like `CURRENT_TIMESTAMP` where applicable.
